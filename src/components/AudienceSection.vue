  ...
  <section id="kineknek" class="relative py-20 md:py-28">
    <div class="max-w-6xl mx-auto px-6">
      ...
      <div class="grid md:grid-cols-2 gap-6">
        <div class="rounded-card bg-rose border border-rose-deep/15 p-7 md:p-8">
        ...
        <div class="rounded-card bg-aqua/15 border border-aqua/25 p-7 md:p-8">
          <h3 class="font-display text-xl text-ink mb-5">{{ audience.notForTitle }}</h3>
          <ul class="space-y-4">
      ...
      <div class="mt-8 border border-dashed border-gold/50 bg-gold/[0.08] rounded-card px-6 py-5 text-sm text-ink/70 leading-relaxed">
        {{ audience.disclaimer }}
      </div>
    </div>
  </section>
